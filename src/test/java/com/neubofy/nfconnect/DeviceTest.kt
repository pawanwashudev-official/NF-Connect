...
import com.neubofy.nfconnect.backends.lan.LanLink
import com.neubofy.nfconnect.backends.lan.LanLinkProvider
import com.neubofy.nfconnect.DeviceInfo.Companion.fromIdentityPacketAndCert
import com.neubofy.nfconnect.DeviceInfo.Companion.isValidDeviceId
import com.neubofy.nfconnect.DeviceInfo.Companion.isValidIdentityPacket
import com.neubofy.nfconnect.DeviceInfo.Companion.loadFromSettings
import com.neubofy.nfconnect.DeviceType.Companion.fromString
import com.neubofy.nfconnect.helpers.DeviceHelper
import com.neubofy.nfconnect.helpers.security.RsaHelper
...
class DeviceTest {
    ...
    fun testDeviceInfoToIdentityPacket() {
        ...
        deviceInfo.incomingCapabilities = hashSetOf("NfConnect.plugin1State", "NfConnect.plugin2State")
        deviceInfo.outgoingCapabilities = hashSetOf("NfConnect.plugin1State.request", "NfConnect.plugin2State.request")
