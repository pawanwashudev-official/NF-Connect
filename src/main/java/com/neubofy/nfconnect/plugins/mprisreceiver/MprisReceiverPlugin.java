...
package com.neubofy.nfconnect.plugins.mprisreceiver;
...
import com.neubofy.nfconnect.helpers.AppsHelper;
...
public class MprisReceiverPlugin extends Plugin {
    ...
    private void createPlayer(MediaController controller) {
        // Skip the media session we created ourselves as NF Connect
