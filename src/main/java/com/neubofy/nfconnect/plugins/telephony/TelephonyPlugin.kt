 ...
 */
package com.neubofy.nfconnect.plugins.telephony
...
class TelephonyPlugin : Plugin() {
    ...
    companion object {
         ...
         */
        const val PACKET_TYPE_TELEPHONY: String = "NfConnect.telephony"
         ...
         */
        private const val PACKET_TYPE_TELEPHONY_REQUEST_MUTE = "NfConnect.telephony.request_mute"
