...
*/
package com.neubofy.nfconnect.plugins.mpris
...
internal object AlbumArtCache {
    ...
    fun initializeDiskCache(context: Context) {
        ...
        try {
            ...
            Log.e("NF/Mpris/AlbumArtCache", "Could not open the album art disk cache!", e)
        }
    ...
    fun getAlbumArt(albumUrl: String?, plugin: MprisPlugin, player: String?): Bitmap? {
        ...
        if (!this::diskCache.isInitialized) {
            Log.e("NF/Mpris/AlbumArtCache", "The disk cache is not initialized!")
            return null
        }
        try {
            ...
            if (item != null) {
                ...
                if (result != null) {
                    ...
                    Log.d("NF/Mpris/AlbumArtCache", "Invalid image: $albumUrl")
                }
    ...
    private fun initiateFetch() {
        ...
        try {
            ...
            Log.e("NF/Mpris/AlbumArtCache", "Problems with the disk cache", e)
            --numFetching
        }
    }
    ...
    fun payloadToDiskCache(albumUrl: String, payload: Payload?) {
        ...
        if (url.scheme !in REMOTE_FETCH_SCHEMES) {
            ...
            Log.e("NF/Mpris/AlbumArtCache", "Got invalid art url with payload: $albumUrl")
            payload.close()
            return
        }
        ...
        try {
            ...
            Log.e("NF/Mpris/AlbumArtCache", "Disk cache problem!", e)
            payload.close()
            return
        }
    ...
    private fun fetchURL(url: Uri, payload: Payload?, cacheItem: DiskLruCache.Editor) {
        try {
            ...
            try {
                ...
                Log.e("NF/Mpris/AlbumArtCache", "Problem with the disk cache", e)
            }
